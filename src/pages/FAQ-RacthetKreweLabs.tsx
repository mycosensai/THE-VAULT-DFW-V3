...
const faqs = [
  ...
  },
  {
    ...
    a: 'We accept three payment methods: (1) Credit/Debit cards via Stripe Checkout, (2) Cryptocurrency (BTC, ETH, SOL, USDC, DOGE, LTC) via Coinbase Commerce, and (3) direct Solana wallet transfers via Phantom, Solflare, Backpack, or another WalletConnect wallet.'
  },
  {
