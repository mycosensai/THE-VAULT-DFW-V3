    ...
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          {[
            { icon: <Wallet className="w-5 h-5" />, title: "Crypto Payments", text: "All crypto payments go directly wallet-to-wallet on the Solana blockchain. Use Phantom, Solflare, Backpack, or another WalletConnect wallet. We never hold your funds." },
