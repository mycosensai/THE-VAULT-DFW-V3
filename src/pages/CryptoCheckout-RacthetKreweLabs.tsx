        ...
        <div className="bg-[#161616] border border-[#C9A84C]/25 relative">
          ...
          <div className="p-6 sm:p-8 border-b border-[#C9A84C]/10">
            ...
            <p className="text-[10px] text-[#8A6E2F] leading-relaxed mb-3">
              Prefer to pay directly from Phantom, Solflare, Backpack, or another WalletConnect wallet?
              Use the direct Solana transfer option instead.
            </p>
            <Link
            ...
            >
              <Wallet className="w-3.5 h-3.5" /> Pay with WalletConnect
            </Link>
          </div>
