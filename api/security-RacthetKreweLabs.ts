...
export function getSecurityHeaders(): Record<string, string> {
  return {
    ...
    "Content-Security-Policy":
      "default-src 'self'; " +
      "script-src 'self' 'unsafe-inline' js.stripe.com https://esm.sh; " +
      "style-src 'self' 'unsafe-inline' fonts.googleapis.com; " +
      "img-src 'self' data: https: blob:; " +
      "font-src 'self' fonts.gstatic.com data:; " +
      "connect-src 'self' api.stripe.com api.commerce.coinbase.com https://esm.sh https://*.walletconnect.com https://*.reown.com wss://*.walletconnect.com; " +
      "frame-src 'self' js.stripe.com hooks.stripe.com https://*.walletconnect.com https://*.reown.com; " +
      "object-src 'none'; " +
      "base-uri 'self'; " +
      "form-action 'self';",
